...
class APIHandler {
    ...
    public class func postHttpsResponseResults(username: String, password: String, completionHandler: @escaping(Result<DataParsed, APIError>)->Void) {
        ...
        do {
            ...
            let dataTask = URLSession.shared.dataTask(with: request) { data, response, _ in
                ...
                do {
                    let messageData = try JSONDecoder().decode(DataParsed.self, from: jsonData)
    ...
    public class func postHttpsResponse(username: String, password: String, completionHandler: @escaping(DataParsed)->()) {
        ...
        // Corrections:
        // Using an error handler case scenario using Result<> and enumeration
        // Using DispatchGroup instead of DispatchSemaphore
